...
import com.education.vidhyalayaaa.API.Accountapi
import com.education.vidhyalayaaa.API.MomentApi
import com.education.vidhyalayaaa.API.Profileupdateapi
import com.education.vidhyalayaaa.API.Data
import com.education.vidhyalayaaa.API.FileUtils
            ...
            override fun onResponse(
                ...
                if (response.isSuccessful) {
                    ...
                    Picasso.with(context)
                        .load(
                            Data.imageBaseUrl + response.body()!!
                                .get(0).profileimage
                        )

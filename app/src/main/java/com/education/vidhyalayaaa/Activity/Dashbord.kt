...
import com.education.vidhyalayaaa.Adapter.MyAdapter
...
//        this.setRetainInstance(true);
        ...
        Picasso.with(this@Dashbord)
            .load("http://vidhyalaya.co.in/sspanel/" + getdata(Data.student_image))
            .error(R.drawable.ic_account_circle_black_24dp)
            .into(user_img)

        var t_name = findViewById<TextView>(R.id.t_name)
        t_name.text = getdata(Data.Student)
        ...
        when (requestCode) {
            RECORD_REQUEST_CODE -> {
                ...
                if (grantResults.isEmpty() || grantResults[0] != PackageManager.PERMISSION_GRANTED) {
                    ...
                    Toast.makeText(this@Dashbord, "Please Allow Permission", Toast.LENGTH_LONG)
                        .show()
                    makerequest()
                } else {

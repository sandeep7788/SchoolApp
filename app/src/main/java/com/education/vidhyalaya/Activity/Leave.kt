package com.education.vidhyalaya.Activity
...
import com.education.vidhyalaya.API.Profileapi
...
class Leave : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        Picasso.with(this@Leave).load("http://skoolstarr.com/sspanel/"+getdata(Data.student_image))
    ...
    fun load_user() {
        ...
        val loginResponseCall: Call<Profileapi> =
            preferences.getLeaveServices()!!.getLandingPageReport(
                getdata(Data.school_id),
                getdata(Data.id),
                e_reason.text.toString(),
                e_description.text.toString(),
                t_startdate.text.toString(),
                t_enddate.text.toString())!!
        ...
        loginResponseCall.enqueue(object : Callback<Profileapi> {
            ...
            override fun onResponse(call: Call<Profileapi>, response: Response<Profileapi>) {
                ...
                progress!!.dismiss()
//                Toast.makeText(this@Leave,response!!.body()!!.getstatus()+" ",Toast.LENGTH_LONG).show()
                showDialog(response!!.body()!!.getstatus(),SweetAlertDialog.SUCCESS_TYPE)
